...
public class DataTestDAO {
    ...
    private void addCompanionOfPet() {
        oferingsOF.add(new CompanionOfPet(1, 3,  "Marta", new GregorianCalendar(2020,6,10),
        ...
        oferingsOF.add(new CompanionOfPet(2, 4,  "Roser", new GregorianCalendar(2020,6,20),
                "Madrid", "Sta. Cruz de Tenerife","Vuelo", "Perro/a, Gato/a, Otros", null,
                0, null, 2, "Protectora Kitty", 0, null, 0, null));
        oferingsOF.add(new CompanionOfPet(3, 3,  "Marta", new GregorianCalendar(2020,7,26),
